...
enum LocalizedStrings {
    ...
    enum Notification {
        static func description(pass: Pass, satelliteName: String) -> String {
            ...
            let format = NSLocalizedString(
                ...
                tableName: nil,
                bundle: .main,
                value: "%1$@ is rising now from %2$@ and sets into %3$@",
                comment: "The description for the satellite pass notification."
            )
            return String(
                format: format,
                satelliteName.trimmingCharacters(in: .whitespacesAndNewlines),
                riseDirection,
                setDirection
            )
        }
        ...
        static func description(numberOfAlerts: Int) -> String {
            if numberOfAlerts == 0 {
                ...
                let format = NSLocalizedString(
                    ...
                    tableName: nil,
                    bundle: .main,
                    value: "You have %d pending alarms",
