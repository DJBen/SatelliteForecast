...
enum StarryNight {
    static let db = try! Connection(Bundle.main.path(forResource: "stars", ofType: "sqlite3")!)
    ...
    enum Constellations {
        ...
        static let constellationLinePath = Bundle.main.path(forResource: "constellation_lines", ofType: "dat")!
    }
