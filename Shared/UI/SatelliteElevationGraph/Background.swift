...
extension SatelliteElevationGraph {
    ...
    struct Background: View, Equatable {
        static func == (lhs: SatelliteElevationGraph.Background, rhs: SatelliteElevationGraph.Background) -> Bool {
...
#if DEBUG
struct SatelliteElevationGraph_Background_Previews: PreviewProvider {
    static var previews: some View {
        SatelliteElevationGraph.Background(
            state: SatelliteElevationGraph.BackgroundState(
