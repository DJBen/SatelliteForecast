...
extension AllPassesViewState: AppStateMappable {
    public static func project(appState: AppState) -> AllPassesViewState {
...
extension ViewProducer where Context == AllPassesViewContext, ProducedView == AllPassesView {
    public static func allPassesView<S: StoreType>(viewModel: S) -> ViewProducer where S.ActionType == AppAction, S.StateType == AppState {
